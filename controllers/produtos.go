...
func Insert(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		m.CriaNovoProduto(nome, descricao, precoConvertidoParaFloat, quantidadeConvertidaParaInt)
	}
...
func Update(w http.ResponseWriter, r *http.Request) {
    if r.Method == "POST" {
        ...
        m.AtualizaProduto(idConvertidaParaInt, nome, descricao, precoConvertidoParaFloat, quantidadeConvertidaParaInt)
    }
    http.Redirect(w, r, "/", 301)
}
